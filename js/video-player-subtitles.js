var subtitles = {
    T_193646_video_opg1: {
		...
		//from		To			Text
			...
			T(TTime("00:00:03:15"), TTime("00:00:05:15"), "Kim Larsen 1945-2018")
			
        ]
    },
	
	T_193646_video_opg2_v2: {
		lang: "en",
		name: "English",
        tracks: [
		//from		To			Text
			T(TTime("00:00:00:01"), TTime("00:00:03:30"), "Kun tekst, der er relevant for opgavebesvarelsen, er tekstet til talesyntese"),
			T(TTime("00:00:03:30"), TTime("00:00:07:00"), "JONAS fc københavn"),
			T(TTime("00:00:34:15"), TTime("00:00:36:00"), "23 JONAS WIND"),
			T(TTime("00:00:49:15"), TTime("00:00:50:30"), "KRISTENSEN 43"),
			T(TTime("00:01:16:15"), TTime("00:01:17:30"), "CHAMPIONS 2018-2019"),
			T(TTime("00:01:18:15"), TTime("00:01:20:00"), "DANMARK"),
			T(TTime("00:01:33:00"), TTime("00:01:36:00"), "SOLGT TIL SUCCES<br />Danmarks nye fodboldstjerner")
